      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        >
          ...
          <div className="flex items-center gap-4">
            ...
            <div className={`${isMobile ? 'w-12' : 'w-0'} transition-all duration-300`} />
            ...
            >
              ...
              {searchFocused && (
                <motion.div
                  ...
                  className="absolute top-full left-0 right-0 mt-2 p-4 bg-white dark:bg-slate-800 rounded-xl shadow-xl border border-slate-200 dark:border-slate-700 z-50"
                >
...
export function ResponsiveDashboardLayout({ children }: DashboardLayoutProps) {
  return (
    <ThemeProvider>
